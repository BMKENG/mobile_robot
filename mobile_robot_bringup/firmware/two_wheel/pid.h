// 기어비 * 채배 * 엔코더 개수 * 틱수 
// 30 * 4 * 11
#define rotation 1320

//for Encoder pin define
#define ENC1_CHA    PB6  //INT.5
#define ENC1_CHB    PB7
...
#define Kp1 1.5// P-gain 
#define Ki1 0.2// i-gain  
#define Kd1 0.1// d-gain 

#define Kp2 1.5// P-gain 
#define Ki2 0.2// i-gain  
#define Kd2 0.1// d-gain 
...
void t2_ISR(){
    M1vel_PID(m1_ref_spd);
    M2vel_PID(m2_ref_spd);
}
...
void M1doMotor(bool dir, long vel){
  // dir = 1 : cw, dir = 0 : ccw
  digitalWrite(M1_DIR1, !dir);
  digitalWrite(M1_DIR2, dir);
...
void M2doMotor(bool dir, long vel){
  // dir = 1 : cw, dir = 0 : ccw
  digitalWrite(M2_DIR1, dir);
  digitalWrite(M2_DIR2, !dir);
  vel = abs(vel);
